...
<template>
    <admin-layout title="Plan für die Kinderkirche bearbeiten">
        <template slot="navbar-left">
            <nav-button type="primary" title="Plan für die Kinderkirche anzeigen" icon="mdi mdi-table"
                        @click="showTable">Eingabe anzeigen</nav-button>
        </template>
...
export default {
    ...
    methods: {
        showTable() {
            this.$inertia.post(route('inputs.input', 'childrensChurch'), this.setup);
        }
    }
}
</script>

...
export default {
    ...
    data() {
        ...
        if (parseInt(moment().format('MMDD')) <= 701) from = moment().date(1).month(10);
        if (parseInt(moment().format('MMDD')) <= 301) from = moment().date(1).month(6);
        let to = moment(from);
        to.add(4, 'months').subtract(1, 'day');

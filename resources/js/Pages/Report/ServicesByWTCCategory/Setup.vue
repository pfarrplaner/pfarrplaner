...
<template>
    <admin-layout title="Übersicht der Gottesdienste nach AZE-Kategorie">
...
export default {
    name: "Setup",
    props: ['people', 'cities'],
    components: {PeopleSelect, FormDatePicker, FormInput, FormCsrfToken, FormSelectize, SaveButton},
    data() {

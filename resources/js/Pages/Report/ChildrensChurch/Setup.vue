...
<template>
    <admin-layout title="Programm für die Kinderkirche erstellen">
        <template v-slot:navbar-left>
            <save-button label="Erstellen" title="Programm für die Kinderkirche erstellen" @click="renderReport" />
        </template>
        <form method="post" :action="route('reports.render', {report: 'childrensChurch'})" ref="myForm">
            <form-csrf-token />

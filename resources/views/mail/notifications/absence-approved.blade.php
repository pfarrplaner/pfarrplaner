...
<div class="preview" style="display: none; max-height: 0px; overflow: hidden;">
    Für den Urlaubsantrag von {{ $absence->user->fullName() }} ({{ $absence->from->format('d.m.Y') }}-{{ $absence->to->format('d.m.Y') }}) liegt eine neue Genehmigung vor.
</div>
                                                            ...
                                                            <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                ...
                                                                <div>
                                                                    <h4 class="text-center"
                                                                        ...
                                                                        align="center">Eine Genehmigung wurde erteilt</h4>
                                                                    <h5 class="text-muted text-center"
                                                                        ...
                                                                        align="center">Urlaubsantrag von {{ $absence->user->fullName() }} ({{ $absence->from->format('d.m.Y') }}-{{ $absence->to->format('d.m.Y') }})</h5>
                                                                    ...
                                                                    <h5 class="text-center"
                                                                        ...
                                                                        align="center"><strong>Genehmigungen</strong></h5>
                                                                    <table class="table" border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <th style="line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;"
                                                                                align="left" valign="top">Person
                                                                            </th>
                                                                            <th style="line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;"
                                                                                align="left" valign="top">Status
                                                                            </th>
                                                                        </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                        @foreach($absence->user->approvers as $approver)
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                            @if((null !== $approval))
                                                                                @if($approval->status=='approved')genehmigt @else abgelehnt @endif
                                                                            @else

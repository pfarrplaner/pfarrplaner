                    ...
                    <div class="tab-content" style="padding-top: 15px;">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="view">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label>
                                        <input type="radio" name="calendar_view" value="calendar.month" @if($calendarView == 'calendar.month')checked @endif/>
                                ...
                                <div class="col-6">
                                    <label>
                                        <input type="radio" name="calendar_view" value="calendar.month_vertical" @if($calendarView == 'calendar.month_vertical')checked @endif/>
                                        <div style="border: solid 1px #dddddd; padding: 3px; border-radius: 3px; display: inline-block;">

<GraphicLine Self="{{ $uid }}" ContentType="Unassigned" LockState="None" OverriddenPageItemProps="" Visible="true" Name="$ID/" HorizontalLayoutConstraints="FlexibleDimension FixedDimension FlexibleDimension" VerticalLayoutConstraints="FlexibleDimension FixedDimension FlexibleDimension" StrokeWeight="0.5" StrokeColor="Color/C=20 M=14 Y=15 K=0" GradientFillStart="0 0" GradientFillLength="0" GradientFillAngle="0" GradientStrokeStart="0 0" GradientStrokeLength="0" GradientStrokeAngle="0" ItemLayer="u4907" Locked="false" LocalDisplaySetting="Default" GradientFillHiliteLength="0" GradientFillHiliteAngle="0" GradientStrokeHiliteLength="0" GradientStrokeHiliteAngle="0" AppliedObjectStyle="ObjectStyle/$ID/[Normal Graphics Frame]" ItemTransform="1 0 0 1 {{ str_replace(',', '.', (string)$col[0]) }} {{ str_replace(',', '.', (string)$y) }}" ParentInterfaceChangeCount="" TargetInterfaceChangeCount="" LastUpdatedInterfaceChangeCount="">
    <Properties>
        <PathGeometry>
            <GeometryPathType PathOpen="true">
                <PathPointArray>
                    <PathPointType Anchor="{{ str_replace(',', '.', (string)$col[1]) }} 7917.165354330709" LeftDirection="{{ str_replace(',', '.', (string)$col[1]) }} 7917.165354330709" RightDirection="{{ str_replace(',', '.', (string)$col[1]) }} 7917.165354330709" />
                    <PathPointType Anchor="{{ str_replace(',', '.', (string)$col[3]) }} 7917.165354330709" LeftDirection="{{ str_replace(',', '.', (string)$col[3]) }} 7917.165354330709" RightDirection="{{ str_replace(',', '.', (string)$col[3]) }} 7917.165354330709" />
                </PathPointArray>
            </GeometryPathType>
        </PathGeometry>
    </Properties>

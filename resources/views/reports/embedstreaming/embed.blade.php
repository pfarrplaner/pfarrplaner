            ...
            <div class="collapsible-body" style="">
                <div class="row ctype-text listtype-none showmobdesk-0">
                    <div id="{{ uniqid() }}" class="col s12 default ">
                        <div style="background-color: orange; position: relative; height: 0; padding-bottom: 56.25%;">
                            <iframe
                                style="background-color: yellow; position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
                            ...
                            @if($nextService->cc_streaming_url)
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        um @if($nextService->cc_alt_time != '') {{ $nextService->cc_alt_time }} @else {{ $nextService->timeText(false) }} @endif
                                        Uhr live übertragen.
                                    </td>
                                    <td valign="top" class="text-right">
    ...
    @foreach ($lastServices as $lastService)
        @if (($lastService->youtube_url != '') || ($lastService->recording_url != ''))
            ...
            <li @if(($loop->index == 1) && ($nextService === null))class="active" @endif>
                <div class="collapsible-header">
                    <span>Gottesdienst am {{ $lastService->day->date->format('d.m.Y') }}</span></div>
                <div class="collapsible-body" style="">
                    <div class="row ctype-text listtype-none showmobdesk-0">
                        <div id="{{ uniqid() }}" class="col s12 default ">
                            @if($lastService->youtube_url != '')
                                <div
                                    style="background-color: orange; position: relative; height: 0; padding-bottom: 56.25%;">
                                    <iframe
                                        style="background-color: yellow; position: absolute; top: 0; left: 0; width: 100%; height: 100%;"

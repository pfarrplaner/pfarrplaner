            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('inputs.input', $input->getKey()) }}">
                    ...
                    <div class="form-group"> <!-- Radio group !-->
                        ...
                        @foreach($locations as $location)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="includeLocations[]" value="{{ $location->id }}"
                    ...
                    <div class="form-group">
                        ...
                        Jede <input type="text" class="form-control" style="width: 50px; display: inline;" name="rhythm" value="1" />. Woche
                    </div>
                    <div class="form-group">

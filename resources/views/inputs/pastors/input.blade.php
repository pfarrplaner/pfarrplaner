...
@section('title') Eingeteilte Pfarrer für {{ $city->name }}, {{ $year}} @endsection
                                ...
                                <td>
                                    <div class="form-group">
                                        <select class="form-control peopleSelect"
                                                name="service[{{$service->id}}][participants][P][]" multiple
                                                data-initial="{{ $service->pastors->pluck('id')->implode(',') }}"
                                                @cannot('gd-pfarrer-bearbeiten') disabled

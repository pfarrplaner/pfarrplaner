            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('weddings.update', $wedding->id) }}" enctype="multipart/form-data">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#comments" role="tab" data-toggle="tab">Kommentare <span class="badge badge-primary" id="commentCount">{{ $wedding->commentsForCurrentUser->count() }}</span></a>
                        </li>
                    </ul>

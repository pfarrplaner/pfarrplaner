...
class DeleteSingleServiceFromCalendarConnection implements ShouldQueue
{
    ...
    /**
     * Execute the job.
     * Gets the appropriate SyncEngine and deletes the service
     *
     * @return void
     */
    public function handle()
    {
        ...
        if ($syncEngine) {
            ...
            $syncEngine->deleteSingleService($this->service);
        } else {
